...
MCP server sidecar providing file access for agents via the `read_file` tool.

Architecture: [files-mcp](https://github.com/agynio/architecture/blob/main/architecture/files-mcp.md)
